...
def observe():
    ...
    prompt = "Pretend you are a curious space alien from the future. You see the following scene: \n"
    ...
    prompt += "Pick one item, and respond with a JSON response about why that item is interesting to you. Also include in the JSON one sentence you'll say when you see it, and another sentence you'd say when you get there. The keys of the JSON response should be index, description, sentence1, and sentence2"
